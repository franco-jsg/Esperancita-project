...
const Separator_about_servicios = () => {
  ...
  return (
    <div className="separator-container-about separator_services">
      <h3 className="separator-about-title">{ lenguage === "ES" ? "Servicios" : "Services" }</h3>
...
export default Separator_about_servicios;
