        ...
        <div>
          ...
          <div className="section_2__videos">
            ...
            <div className="other_videos">
              <Secondary_video secondary_video={secondary_video_1} CubeSecondary={CubeSecondary} LogoSecondary={LogoSecondary}/>
              <Secondary_video secondary_video={secondary_video_2} CubeSecondary={CubeSecondary} LogoSecondary={LogoSecondary} />
              <Secondary_video secondary_video={secondary_video_2} CubeSecondary={CubeSecondary} LogoSecondary={LogoSecondary} />
            </div>
          </div>
        </div>
